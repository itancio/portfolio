...
abstract: 'This is an end-to-end encryption file sharing system.
        Implemented 8 user functions: initUser, GetUser, user.storeFile, 
        user.loadFile, user.appendFile, user.createInvitation, user.acceptInvitation, 
        user.revokeAccess.'
categories: ['All', 'Code']
date: '2022-04-21'
