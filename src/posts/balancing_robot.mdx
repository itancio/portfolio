...
abstract: 'Project Description: (Based on[midhun_s self-balancing robot](https://www.instructables.com/Arduino-Self-Balancing-Robot-1/)). 
            This bi-wheeled robot resembles an inverted pendulum with self correcting
